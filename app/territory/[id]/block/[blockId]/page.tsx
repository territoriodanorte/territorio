...
export default function BlockPage() {
  ...
  const addHouse = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const novaLista = [...houses, { id: newHouseRef.id, side: addingToSide.side, number: newHouseNumber.trim(), status: 'not_visited' as const, order: addingToSide.orderIndex, createdAt: Date.now() }];
      atualizarContadores(novaLista);
    } finally {
